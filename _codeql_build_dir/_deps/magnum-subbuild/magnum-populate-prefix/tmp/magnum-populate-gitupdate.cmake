...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "b85f0c8dfeef12c209bfb2dfc4efd1d79cdd1c9e"
  WORKING_DIRECTORY "/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/magnum-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "b85f0c8dfeef12c209bfb2dfc4efd1d79cdd1c9e")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("b85f0c8dfeef12c209bfb2dfc4efd1d79cdd1c9e" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: b85f0c8dfeef12c209bfb2dfc4efd1d79cdd1c9e")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/b85f0c8dfeef12c209bfb2dfc4efd1d79cdd1c9e")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"b85f0c8dfeef12c209bfb2dfc4efd1d79cdd1c9e\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/magnum-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/magnum-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
