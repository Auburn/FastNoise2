...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "db2ef1192a4ddff32a838094de7127142a731ef0"
  WORKING_DIRECTORY "/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/imnodes-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/imnodes-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/imnodes-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
