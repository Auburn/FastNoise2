...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "f37591439479a5169134f8f2eba551b95054057a"
  WORKING_DIRECTORY "/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/corrade-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "f37591439479a5169134f8f2eba551b95054057a")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("f37591439479a5169134f8f2eba551b95054057a" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: f37591439479a5169134f8f2eba551b95054057a")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/f37591439479a5169134f8f2eba551b95054057a")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"f37591439479a5169134f8f2eba551b95054057a\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/corrade-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/FastNoise2/FastNoise2/_codeql_build_dir/_deps/corrade-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
