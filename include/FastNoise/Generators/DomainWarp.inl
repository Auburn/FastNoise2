...
public:
    ...
    #define GRADIENT_COORD( _x, _y )\
        int32v hash##_x##_y = Utils::HashPrimesHB(seed, x##_x, y##_y );\
    ...
    #undef GRADIENT_COORD
        ...
        xOut = FS_FMulAdd_f32( Utils::Lerp( Utils::Lerp( x00, x10, xs ), Utils::Lerp( x01, x11, xs ), ys ) - float32v( 0xffff / 2.0f ), normalise, xOut );
        yOut = FS_FMulAdd_f32( Utils::Lerp( Utils::Lerp( y00, y10, xs ), Utils::Lerp( y01, y11, xs ), ys ) - float32v( 0xffff / 2.0f ), normalise, yOut );
    }
    ...
    #define GRADIENT_COORD( _x, _y, _z )\
        int32v hash##_x##_y##_z = Utils::HashPrimesHB( seed, x##_x, y##_y, z##_z );\
    ...
    #undef GRADIENT_COORD
        ...
        float32v x0z = Utils::Lerp( Utils::Lerp( x000, x100, xs ), Utils::Lerp( x010, x110, xs ), ys );
        float32v y0z = Utils::Lerp( Utils::Lerp( y000, y100, xs ), Utils::Lerp( y010, y110, xs ), ys );
        float32v z0z = Utils::Lerp( Utils::Lerp( z000, z100, xs ), Utils::Lerp( z010, z110, xs ), ys );
                   
        float32v x1z = Utils::Lerp( Utils::Lerp( x001, x101, xs ), Utils::Lerp( x011, x111, xs ), ys );
        float32v y1z = Utils::Lerp( Utils::Lerp( y001, y101, xs ), Utils::Lerp( y011, y111, xs ), ys );
        float32v z1z = Utils::Lerp( Utils::Lerp( z001, z101, xs ), Utils::Lerp( z011, z111, xs ), ys );

        float32v normalise = warpAmp * float32v( 1.0f / (0x3ff / 2.0f) );

        xOut = FS_FMulAdd_f32( Utils::Lerp( x0z, x1z, zs ) - float32v( 0x3ff / 2.0f ), normalise, xOut );
        yOut = FS_FMulAdd_f32( Utils::Lerp( y0z, y1z, zs ) - float32v( 0x3ff / 2.0f ), normalise, yOut );
        zOut = FS_FMulAdd_f32( Utils::Lerp( z0z, z1z, zs ) - float32v( 0x3ff / 2.0f ), normalise, zOut );
    }
    ...
    #define GRADIENT_COORD( _x, _y, _z, _w )\
        int32v hash##_x##_y##_z##_w = Utils::HashPrimesHB( seed, x##_x, y##_y, z##_z, w##_w );\
    ...
    #undef GRADIENT_COORD
        ...
        float32v x0w = Utils::Lerp( Utils::Lerp( Utils::Lerp( x0000, x1000, xs ), Utils::Lerp( x0100, x1100, xs ), ys ), Utils::Lerp( Utils::Lerp( x0010, x1010, xs ), Utils::Lerp( x0110, x1110, xs ), ys ), zs );
        float32v y0w = Utils::Lerp( Utils::Lerp( Utils::Lerp( y0000, y1000, xs ), Utils::Lerp( y0100, y1100, xs ), ys ), Utils::Lerp( Utils::Lerp( y0010, y1010, xs ), Utils::Lerp( y0110, y1110, xs ), ys ), zs );
        float32v z0w = Utils::Lerp( Utils::Lerp( Utils::Lerp( z0000, z1000, xs ), Utils::Lerp( z0100, z1100, xs ), ys ), Utils::Lerp( Utils::Lerp( z0010, z1010, xs ), Utils::Lerp( z0110, z1110, xs ), ys ), zs );
        float32v w0w = Utils::Lerp( Utils::Lerp( Utils::Lerp( w0000, w1000, xs ), Utils::Lerp( w0100, w1100, xs ), ys ), Utils::Lerp( Utils::Lerp( w0010, w1010, xs ), Utils::Lerp( w0110, w1110, xs ), ys ), zs );

        float32v x1w = Utils::Lerp( Utils::Lerp( Utils::Lerp( x0001, x1001, xs ), Utils::Lerp( x0101, x1101, xs ), ys ), Utils::Lerp( Utils::Lerp( x0011, x1011, xs ), Utils::Lerp( x0111, x1111, xs ), ys ), zs );
        float32v y1w = Utils::Lerp( Utils::Lerp( Utils::Lerp( y0001, y1001, xs ), Utils::Lerp( y0101, y1101, xs ), ys ), Utils::Lerp( Utils::Lerp( y0011, y1011, xs ), Utils::Lerp( y0111, y1111, xs ), ys ), zs );
        float32v z1w = Utils::Lerp( Utils::Lerp( Utils::Lerp( z0001, z1001, xs ), Utils::Lerp( z0101, z1101, xs ), ys ), Utils::Lerp( Utils::Lerp( z0011, z1011, xs ), Utils::Lerp( z0111, z1111, xs ), ys ), zs );
        float32v w1w = Utils::Lerp( Utils::Lerp( Utils::Lerp( w0001, w1001, xs ), Utils::Lerp( w0101, w1101, xs ), ys ), Utils::Lerp( Utils::Lerp( w0011, w1011, xs ), Utils::Lerp( w0111, w1111, xs ), ys ), zs );                        

        float32v normalise = warpAmp * float32v( 1.0f / (0xff / 2.0f) );

        xOut = FS_FMulAdd_f32( Utils::Lerp( x0w, x1w, ws ) - float32v( 0xff / 2.0f ), normalise, xOut );
        yOut = FS_FMulAdd_f32( Utils::Lerp( y0w, y1w, ws ) - float32v( 0xff / 2.0f ), normalise, yOut );
        zOut = FS_FMulAdd_f32( Utils::Lerp( z0w, z1w, ws ) - float32v( 0xff / 2.0f ), normalise, zOut );
        wOut = FS_FMulAdd_f32( Utils::Lerp( w0w, w1w, ws ) - float32v( 0xff / 2.0f ), normalise, wOut );
    }
};
