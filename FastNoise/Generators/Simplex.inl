...
namespace FastNoise
{
    template<typename T_FS, FastSIMD::eLevel = T_FS::SIMD_Level>
    class Simplex_FS : public virtual Simplex, public Generator_FS<T_FS>
    {
        ...
        float32v FS_VECTORCALL Gen( int32v seed, float32v x, float32v y, float32v z ) final
        {
